...
class Model_DbTable_Products_Stock_Stocktake extends Zend_Db_Table_Abstract {
...
public function getStocktake( $idTake){
	...
	public function updateActStock($id,$qty){
	...
	public function cleanListByDate($date,$shop){
		$condStr  = "`date_take`= '".$date."' AND `location` LIKE '".$shop."'";
		$this->delete($condStr);
	}
