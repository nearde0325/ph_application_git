...
function template_functions(){
	...
	$('#btn_remove_product').click(function(e){
		e.preventDefault();
		$('#modal_remove_product').modal('show');
	});
	$('#btn_save_change').click(function(e){
		e.preventDefault();
		$('#modal_save_change').modal('show');
	});
	$('#btn_cancel_order').click(function(e){
		e.preventDefault();
		$('#modal_cancel_order').modal('show');
	});
	$('#btn_final_order').click(function(e){
		e.preventDefault();
		$('#modal_final_order').modal('show');
	});			
