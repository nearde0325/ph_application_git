...
if(isset($_POST['token']) AND $_POST['token']=='AsDfGhJkL'){
	...
	if($_POST['product_code']!=""){
		...
		$fileName= trim($_POST['product_code'])."_0.jpg";
			...
			//}
			if (move_uploaded_file($_FILES['ebay_file']['tmp_name'],$cpath."/shiplocal_gallery_img/".$fileName)) {
			//begin to do somthing
			$result.="SUCCESS Upload USA Main Gallery Image<br />";
			}
		}
...
<?php
echo $_SERVER['SERVER_NAME']."/product_img/shiplocal_gallery_img/".$fileName;
?>
