		...
		$fileName= trim($_POST['product_code']);
			...
			for($i=1;$i<11;$i++){
				...
				if($_FILES[$fileName."_".$i]['tmp_name']!=""){
					//echo "Not Empty";
					if (move_uploaded_file($_FILES[$fileName."_".$i]['tmp_name'],$cpath."/shiplocal_extra_img/".$fileNameWithNo)) {
				//begin to do somthing
					$result="SUCCESS";
					echo "&lt; img src=\"http://www.newgenerationgroup.com.au/product_img/shiplocal_extra_img/$fileNameWithNo\" border=\"0\" width=\"600\" height=\"600\" / &gt;&lt;br /&gt;<br />";
					}				
				}
			}		
         echo "-----------------END COPY-----------------<br />";
