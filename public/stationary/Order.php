...
public static function getCustomerOrdersLastWeek($id_customer, $showHiddenStatus = false, Context $context = null)
	{
		date_default_timezone_set('Australia/Melbourne');
		...
		if(intval(date("w"))==1){
			...
			$thisMonday = date("Y-m-d H:i:s",date_sub(strtotime($thisMonday),'P7D'));
...
public static function getCustomerOrdersByDate($id_customer,$dateBegin,$dateEnd, $showHiddenStatus = false, Context $context = null)
	{
		date_default_timezone_set('Australia/Melbourne');
		...
		echo $beginDate = date("Y-m-d H:i:s",strtotime($dateBegin));
		echo $endDate = date("Y-m-d H:i:s",strtotime($dateEnd." 23:59:59"));
