$(document).ready(function() {
	...
	$('#btn_final').click(function(){
		$("#form_main").attr("action","/roster/save-confirm-roster");
$("#form_main").submit();
		});
...
$("#form_main").submit();
	...
	$('#btn_final_arrange').click(function(){
		$("#form_main").attr("action","/roster/save-arrange-roster");
$("#form_main").submit();
		});	
		
		$('#su_final_arrange_app').click(function(){
		$("#form_main").attr("action","/roster/save-arrange-roster");
$("#form_main").submit();
		});
		
		$('#su_final_arrange_rej').click(function(){
		$("#form_main").attr("action","/roster/save-arrange-roster");
$("#form_main").submit();
		});
