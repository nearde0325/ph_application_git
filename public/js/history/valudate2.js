...
$(function(){
	$("#wizard").scrollable({
		...
		if(i==4){
				...
				var total_electronic_cash = $("#total_electronic_cash").val();
				var efpos_total_check = $("#efpos_total_check").val();
				if(parseFloat(total_electronic_cash) != parseFloat(efpos_total_check) ){
						$("#error_message_4").removeClass("error_inv");
						$("#error_message_4").addClass("error");
						
						document.getElementById("error_detail_4").innerHTML = "Electronic Sales Details do Not Match Electronic Sales Total you filled earlier!!<br />";					
						return false;					
