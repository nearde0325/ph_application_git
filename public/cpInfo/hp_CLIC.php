...
<title>[CLIC] Comapny Home Apps</title>
<style>
#newBox {
       position:absolute;
       width:972px;
...
<ul id="a">
  ...
  <tr>
    ...
    <iframe width="100%" height="220" src="http://115.64.171.97:1080/stock/kakt-notice/shop/CLIC" scrolling="no" frameborder="0"></iframe> 
    <iframe width="100%" height="180" src="http://115.64.171.97:1080/customer/inquery/shop/CLIC" scrolling="no" frameborder="0"></iframe>
    </td>
  </tr>
</table>
    <br />
   ...
   <div class="dvblockred"> <a href="http://115.64.171.97:1080/products/finder-public/shop/CLIC" target="_blank">Online Product Finder</a></div> 
...
<ul id="b">
    ...
    <div class="dvblock"> <a href="http://115.64.171.97:1080/roster/upload-roster/shop/CLIC" >Upload Roster</a></div> 
        <div class="dvblock"> <a href="http://115.64.171.97:1080/roster/check-online-roster/shop/CLIC" target="_blank" >Check Online Rosters</a></div>
</ul>

<ul id="c">
    <h1>Company Applications</h1>
	<div class="dvblock"> <a href="http://115.64.171.97:1080/rma/new/shop/CLIC" target="_blank">RMA System[Return Faulty]</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/cashaccount/index/shop/CLIC" target="_blank">Cash Account</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/repaircenter/mainpage/shop/CLIC" target="_blank">Mobile Phone Repair</a></div>
	<div class="dvblock"> <a href="http://115.64.171.97:1080/roster/login/shop/CLIC?token=0d9ca92a8ad799cec6e7cddec6118047" >Staff Attendance</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/stock/check-shop-kakt/shop/CLIC" target="_blank" >KA/KT Management</a></div>
    <?php
    date_default_timezone_set("Australia/Melbourne");
	$dailyLink = "http://115.64.171.97:1080/salesmonitor/daily-stock-take-list/shop/CLIC";
	$weeklyLink = "";
	$dayToday = date("N");
	if($dayToday == 1){
		$dailyLink = "";
		$weeklyLink ="http://115.64.171.97:1080/salesmonitor/show-weekly-stock-take-diff/shop/CLIC";
    ...
    <div class="dvblock"> <a href="<?php echo $weeklyLink;?>" target="_blank" >Weekly Stock Take<br /><br />
      ...
      <?php 
	  $uQty = file_get_contents("http://115.64.171.97:1080/products/get-unhandled-count/shop/CLIC");
	  if((int)$uQty >20){
	  ?>
      <div class="dvblockred"> <a href="http://115.64.171.97:1080/products/extra-order/shop/CLIC" target="_blank" >Sold Out Items<br /><br />
      <span style="font-size:13px; color:#FFF"><?php echo $uQty." Items To Do !!"; ?></span></a></div>
      <?php }else {?>
          <div class="dvblock"> <a href="http://115.64.171.97:1080/products/extra-order/shop/CLIC" target="_blank" >Sold Out Items<br /><br />
      <span style="font-size:12px; color:#F00">Complete before Monday</span></a></div>
      <?php }?>
<div class="dvblock"> <a href="http://115.64.171.97:1080/roster/start-here/shop/CLIC"  target="_blank" >New Staff<br />Registration <br /><br />
 </a></div> 
<div class="dvblock"> <a href="http://115.64.171.97:1080/products/shop-analysis-public/shop/CLIC"  target="_blank" >Shop Analysis <br /><br />
 </a></div> 
