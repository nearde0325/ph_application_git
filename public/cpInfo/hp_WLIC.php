...
<title>[WLIC] Comapny Home Apps</title>
<style>
#newBox {
       position:absolute;
       width:972px;
...
<ul id="a">
  ...
  <tr>
    ...
    <iframe width="100%" height="220" src="http://115.64.171.97:1080/stock/kakt-notice/shop/WLIC" scrolling="no" frameborder="0"></iframe> 
    <iframe width="100%" height="180" src="http://115.64.171.97:1080/customer/inquery/shop/WLIC" scrolling="no" frameborder="0"></iframe>
    </td>
  </tr>
</table>
    <br />
   ...
   <div class="dvblockred"> <a href="http://115.64.171.97:1080/products/finder-public/shop/WLIC" target="_blank">Online Product Finder</a></div> 
...
<ul id="b">
    ...
    <div class="dvblock"> <a href="http://115.64.171.97:1080/roster/upload-roster/shop/WLIC" >Upload Roster</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/roster/check-online-roster/shop/WLIC" target="_blank" >Check Online Rosters</a></div>
</ul>

<ul id="c">
    <h1>Company Applications</h1>
	<div class="dvblock"> <a href="http://115.64.171.97:1080/rma/new/shop/WLIC" target="_blank">RMA System[Return Faulty]</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/cashaccount/index/shop/WLIC" target="_blank">Cash Account</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/repaircenter/mainpage/shop/WLIC" target="_blank">Mobile Phone Repair</a></div>
	<div class="dvblock"> <a href="http://115.64.171.97:1080/roster/login/shop/WLIC?token=d9763570f56bfb26d6b21c8e674234bf">Staff Attendance</a></div>
    <div class="dvblock"> <a href="http://115.64.171.97:1080/stock/check-shop-kakt/shop/WLIC" target="_blank" >KA/KT Management</a></div>
    <?php

	$dailyLink = "http://115.64.171.97:1080/salesmonitor/daily-stock-take-list/shop/WLIC";
	$weeklyLink = "";
	$dayToday = date("N");
	if($dayToday == 1){
		$dailyLink = "";
		$weeklyLink ="http://115.64.171.97:1080/salesmonitor/show-weekly-stock-take-diff/shop/WLIC";
    ...
    <div class="dvblock"> <a href="<?php echo $weeklyLink;?>" target="_blank" >Weekly Stock Take<br /><br />
      ...
      <?php 
	  $uQty = file_get_contents("http://115.64.171.97:1080/products/get-unhandled-count/shop/WLIC");
	  if((int)$uQty >20){
	  ?>
      <div class="dvblockred"> <a href="http://115.64.171.97:1080/products/extra-order/shop/WLIC" target="_blank" >Sold Out Items<br /><br />
      <span style="font-size:13px; color:#FFF"><?php echo $uQty." Items To Do !!"; ?></span></a></div>
      <?php }else {?>
          <div class="dvblock"> <a href="http://115.64.171.97:1080/products/extra-order/shop/WLIC" target="_blank" >Sold Out Items<br /><br />
      <span style="font-size:12px; color:#F00">Complete before Monday</span></a></div>
      <?php }?>
<div class="dvblock"> <a href="http://115.64.171.97:1080/roster/start-here/shop/WLIC"  target="_blank" >New Staff<br />Registration <br /><br />
 </a></div> 
<div class="dvblock"> <a href="http://115.64.171.97:1080/products/shop-analysis-public/shop/WLIC"  target="_blank" >Shop Analysis <br /><br />
 </a></div> 
...
<ul id="d">
    ...
    <div class="dvblock"><a href="https://docs.google.com/forms/d/1gBq5TW8U6tiCeSdsrsv-nFJPPPp_0igvDBNvmbMxDfA/viewform" target="_blank">Online Leave Application  Form</a></div>
</ul>
<ul id="e">
